            ...
            <form action="" onSubmit={handleSubmit(onSubmit)}>
                <div className='space-y-12'>
                    <div className='border-b border-gray-900 pb-12'>
                        <h2 className='text-2xl font-bold text-gray-900 leading-7'>Create a group chat</h2>
                        <p className='text-gray-600 text-sm leading-6 mt-1'>Start a conversation with your friends by creating a proletariat</p>
